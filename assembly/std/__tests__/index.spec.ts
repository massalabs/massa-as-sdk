...
const keys_ser_ko1: StaticArray<u8> = [3, 0, 0, 0, 2]; // wrong format; 3 vec; 1st vec len = 2; no data for 1st vec
const keys_ser_ko2: StaticArray<u8> = [1, 0, 0, 0, 3, 1, 2]; // wrong format; 1 vec; 1st vec len = 3; not enough data for 1st vec
const keys_ser_ko3: StaticArray<u8> = [1, 0, 0, 0, 255, 1, 2]; // wrong format; 1 vec; 1st vec len = 255; not enough data for 1st vec
const keys_ser_ko4: StaticArray<u8> = [255, 255, 255, 255, 2]; // invalid; too much entry
const keys_ser_ko5: StaticArray<u8> = [1, 0, 0, 0, 0]; // edge case; not invalid but meh :-/
const keys_ser_ko6: StaticArray<u8> = [0, 0, 0, 0, 0]; // edge case; not invalid but meh :-/
const keys_ser_ko7: StaticArray<u8> = [1, 0, 0, 0, 2, 127, 254, 1, 99]; // invalid only 1 entry but 2 entries in data
